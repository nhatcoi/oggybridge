...
Download from **[Releases v0.1.9](https://github.com/nhatcoi/oggybridge/releases/tag/v0.1.9)** or install directly:

```bash
curl -LO https://github.com/nhatcoi/oggybridge/releases/download/v0.1.9/OggyBridge_0.1.9_amd64.deb
sudo dpkg -i OggyBridge_0.1.9_amd64.deb
oggybridge
```
...
```bash
curl -LO https://github.com/nhatcoi/oggybridge/releases/download/v0.1.9/OggyBridge_0.1.9_aarch64.dmg
open OggyBridge_0.1.9_aarch64.dmg
```
