...
const en = {
  ...
  "settings.agents.extraArgsPlaceholder": "extra args (e.g. --dangerously-skip-permissions)",
  "settings.agents.templateAutoApproval": "auto-approval",
  "settings.agents.customSection": "Custom Agents",
  "settings.agents.addCustom": "+ Add custom agent",
  "settings.agents.customLabelPlaceholder": "Display name (e.g. My Agent)",
  "settings.agents.customCmdPlaceholder": "Command (e.g. my-agent-cli)",
  "settings.agents.customExtraArgsPlaceholder": "Extra args (optional)",
  "settings.agents.save": "Save",
  "settings.agents.cancel": "Cancel",
  "settings.agents.add": "Add",
  ...
  "editor.openWorkspace": "Open a workspace to edit files.",
  "editor.browser": "Browser",
  "editor.open": "Open",
  "editor.layout.side": "Beside panes",
  "editor.layout.fullscreen": "Full screen",
  "editor.files": "Files",
  "editor.loading": "Loading",
  "editor.search": "Search files...",
  "editor.noFiles": "No editable files found.",
  "editor.noFileSelected": "No file selected",
  "editor.selectFile": "Select a file from the tree to preview it here.",
  "editor.confirmDiscard": "Discard unsaved changes?",
...
const vi: Record<TranslationKey, string> = {
  ...
  "settings.agents.extraArgsPlaceholder": "tham số thêm (vd. --dangerously-skip-permissions)",
  "settings.agents.templateAutoApproval": "tự động duyệt",
  "settings.agents.customSection": "Agent tùy chỉnh",
  "settings.agents.addCustom": "+ Thêm agent tùy chỉnh",
  "settings.agents.customLabelPlaceholder": "Tên hiển thị (vd. My Agent)",
  "settings.agents.customCmdPlaceholder": "Lệnh (vd. my-agent-cli)",
  "settings.agents.customExtraArgsPlaceholder": "Tham số thêm (tuỳ chọn)",
  "settings.agents.save": "Lưu",
  "settings.agents.cancel": "Hủy",
  "settings.agents.add": "Thêm",
  ...
  "editor.openWorkspace": "Mở workspace để chỉnh sửa file.",
  "editor.browser": "Browser",
  "editor.open": "Mở",
  "editor.layout.side": "Cạnh pane",
  "editor.layout.fullscreen": "Toàn màn hình",
  "editor.files": "Files",
  "editor.loading": "Đang tải",
  "editor.search": "Tìm file...",
  "editor.noFiles": "Không tìm thấy file có thể sửa.",
  "editor.noFileSelected": "Chưa chọn file",
  "editor.selectFile": "Chọn một file trong cây thư mục để xem tại đây.",
  "editor.confirmDiscard": "Bỏ các thay đổi chưa lưu?",
